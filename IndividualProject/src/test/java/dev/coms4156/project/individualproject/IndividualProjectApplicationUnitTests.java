 ...
 * Contained in this file is primarily validating of the {@code resetDataFile()}. Which is critical to ensuring
 * that the data.txt file has the correct information.
 */
public class IndividualProjectApplicationUnitTests {
    ...
    /**
     * This method determines whether a course in the course mapping of a department has the expected fields.
     *
     ...
     */
    private void validateCourseInfo(HashMap<String, Course> courses, String courseCode,
        ...
        assertEquals(expectedEnrollment, course.getEnrolledStudentCount());
    }

    /**
     * This function tests the {@code resetDataFile()} method in the IndividualProjectApplication class.
     * It determines if the data mapping, is accurate and contains all the information hard-coded in the
    ...
    public void testResetDataFile() {
        ...
        ArgumentCaptor<HashMap<String, Department>> argumentCaptor = ArgumentCaptor.forClass(HashMap.class);
        verify(mockDatabase, times(1)).setMapping(argumentCaptor.capture());

        HashMap<String, Department> departmentMapping = argumentCaptor.getValue();
    ...
    /**
     * This method verifies that all the relevant COMS classes are present in the COMS department object.
     *
     * @param departmentMapping
     */
    private void validateComsDept(HashMap<String, Department> departmentMapping) {
    ...
    /**
     * This method verifies that all the relevant ECON courses are present in the ECON department object.
     *
     * @param departmentMapping
     */
    private void validateEconDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info
    ...
    /**
     * This method verifies that all the relevant IEOR courses are present in the IEOR department object.
     *
     * @param departmentMapping
     */
    private void validateIeorDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info
    ...
    /**
     * This method verifies that all the relevant CHEM courses are present in the CHEM department object.
     *
     * @param departmentMapping
     */
    private void validateChemDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info
    ...
    /**
     * This method verifies that all the relevant PHYS courses are present in the PHYS department object.
     *
     * @param departmentMapping
     */
    private void validatePhysDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info
     ...
     * @param departmentMapping
     */
    private void validateElenDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info
    ...
    /**
     * This method verifies that all the relevant PYSC courses are present in the PYSC department object.
     *
     * @param departmentMapping
     */
    private void validatePsycDept(HashMap<String, Department> departmentMapping) {
        // Validate Department Info

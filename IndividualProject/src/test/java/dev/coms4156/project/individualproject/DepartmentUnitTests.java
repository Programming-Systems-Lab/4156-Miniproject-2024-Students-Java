...
public class DepartmentUnitTests {
     ...
     *
     * <p>In the implementation of this test, we create a hashmap of expected course based on data.txt.
     * We then retrieve the actual courses hashmap from {@code compSciDept} and convert both to strings.
     * Comparing resulting strings, we can determine if the results are consistent.
     */
    @Test

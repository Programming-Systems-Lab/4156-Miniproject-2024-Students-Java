...
public class MyFileDatabaseUnitTests {
  ...
  public static void setupForTesting() {
    ...
    testMyFile = new MyFileDatabase(0, "./data.txt");
    
  }

  @Test
  public void deSerializeObjectFromFileTest() {
    assertEquals(mapping, testMyFile.getDepartmentMapping());
  }
  
  @Test
  public void saveContentsToFileTest() {
    MyFileDatabase testMyFile = new MyFileDatabase(1, "./data_test_ContentsToFile.txt");
    testMyFile.setMapping(mapping);
    testMyFile.saveContentsToFile();
    MyFileDatabase testMyFile2 = new MyFileDatabase(0, "./data_test_ContentsToFile.txt");
    assertEquals(mapping, testMyFile2.getDepartmentMapping());
  }
  ...
  public void toStringTest() {
    ...
    courses.put("4156", coms4156);
    Department compSci = new Department("COMS", courses, "Luca Carloni", 2700);
    HashMap<String, Department> mapping2 = new HashMap<>();

...
public class RouteControllerUnitTests {
  ...
  public static void setupCourseForTesting() {
    ...
    elen = new Department("ELEN", elenCourses, "Ioannis Kymissis", 250);
  ...
  @Test
  public void getMapping_slash_thenReturns200() throws Exception {
    mockMvc.perform(get("/"))
  ...
  @Test
  public void getMapping_index_thenReturns200() throws Exception {
  ...
  @Test
  public void getMapping_home_thenReturns200() throws Exception {
  ...
  @Test
  public void retrieveDepartmentTrueTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/retrieveDept")
        .param("deptCode", "ELEN")
        .accept(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(status().isOk())
        .andExpect(content().string(elen.toString()));
  }

  @Test
  public void retrieveDepartmentFalseTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/retrieveDept")
        .param("deptCode", "COMMUNICATION")
        .accept(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(status().isNotFound())
        .andExpect(content().string(mapping.toString()));
  }
  ...
  @Test
  public void retrieveCourseTest_FoundDeptCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/retrieveCourse")
        ...
        .accept(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(status().isOk())
        .andExpect(content().string(elen.getCourseSelection().get("1201").toString()));
  }

  @Test
  public void retrieveCourseTest_FoundDeptNoCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/retrieveCourse")
        .param("deptCode", "ELEN")
  ...
  @Test
  public void retrieveCourseTest_NotFoundDept() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/retrieveCourse")
        .param("deptCode", "ASHLEY")
        .param("courseCode", "2024")
        .accept(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(status().isNotFound())
  ...
  @Test
  public void isCourseFullTest_FoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void isCourseFullTest_NotFoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/isCourseFull")
        .param("deptCode", "ELEN")
        .param("courseCode", "2024")
  ...
  @Test
  public void getMajorCtFromDeptTrueTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void getMajorCtFromDeptFalseTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/getMajorCountFromDept")
        .param("deptCode", "COMMUNICATION")
        .accept(MediaType.APPLICATION_JSON_VALUE))
  ...
  @Test
  public void identifyDeptChairTrueTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void identifyDeptChairFalseTest() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/idDeptChair")
        .param("deptCode", "COMMUNICATION")
        .accept(MediaType.APPLICATION_JSON_VALUE))
  ...
  @Test
  public void findCourseLocationTest_FoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void findCourseLocationTest_NotFoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/findCourseLocation")
        .param("deptCode", "ELEN")
        .param("courseCode", "2024")
  ...
  @Test
  public void findCourseInstructorTest_FoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void findCourseInstsructorTest_NotFoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/findCourseInstructor")
        .param("deptCode", "ELEN")
        .param("courseCode", "2024")
  ...
  @Test
  public void findCourseTimeTest_NotFoundCourse() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(get("/findCourseTime")
        .param("deptCode", "ELEN")
        .param("courseCode", "2024")
  ...
  @Test
  public void addMajorToDeptTest_FoundDept() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
  ...
  @Test
  public void addMajorToDeptTest_NotFoundDept() throws Exception {
    when(myFileDatabase.getDepartmentMapping()).thenReturn(mapping);
    mockMvc.perform(patch("/addMajorToDept")
        .param("deptCode", "COMMUNICATION")
        .accept(MediaType.APPLICATION_JSON_VALUE))
  ...
  public static HashMap<String, Department> mappingEmpty;
  public static Department elen;
}

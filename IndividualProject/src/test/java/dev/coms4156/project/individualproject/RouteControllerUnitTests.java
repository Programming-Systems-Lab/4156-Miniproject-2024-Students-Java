...
public class RouteControllerUnitTests {
    ...
    public void setup() {
        ...
        // Define data for COMS department
    ...
    public void testRetrieveCourse() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(mapping.get("COMS").getCourseSelection().get("1004").toString(), response.getBody());
    }
    ...
    public void testLocationAndUpdate() {
        ...
        ResponseEntity<?> updateResponse = routeController.changeCourseLocation("COMS", 1004, "451 CSB");

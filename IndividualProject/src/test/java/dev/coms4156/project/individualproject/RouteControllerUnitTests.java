...
public class RouteControllerUnitTests {
  ...
  /**
  * The routeController set up to be tested.
  */
  @BeforeEach
  ...
  public void retrieveCourseExistingTest() {
    ...
    assertEquals(departmentMappingTest.get("COMS")
        .getCourseSelection()
        .get("1004")
  ...
  /**
  * Resets Datafile to the orginial data after being used.
  */
  @AfterAll
  public static void resetDataFile() {
    IndividualProjectApplication appTest = new IndividualProjectApplication();
    String[] args = {"setup"};
    appTest.run(args);
  }

...
public class RouteControllerUnitTests {
  ...
  public void testIndex() {
    ...
    String expectedResponse = "Welcome, in order to make an API call direct your browser or Postman to an endpoint "
    ...
    private void performGetRequestTest(String route, String queryParams, ResultMatcher expectedStatus, String expectedContent) throws Exception {
   ...
   public void testWrongRetrieveCourse() throws Exception {
    ...
    public void testInvalidMajorsInDepartment() throws Exception {
        performGetRequestTest("/getMajorCountFromDept","deptCode=electrical", status().isNotFound(),"Department Not Found");
    }
    ...
    public void testDeptChair() throws Exception {
        performGetRequestTest("/idDeptChair","deptCode=COMS", status().isOk(),"Luca Carloni is the department chair.");
    }

    @Test
    public void testDeptChairDepartmentNA() throws Exception {
        performGetRequestTest("/idDeptChair","deptCode=electrical", status().isNotFound(),"Department Not Found");
    }
    ...
    public void testValidCourseLocation() throws Exception {
        performGetRequestTest("/findCourseLocation", "deptCode=COMS&courseCode=3261", status().isOk(), "");
    }

    @Test
    public void testInvalidCourseLocation() throws Exception {
        performGetRequestTest("/findCourseLocation", "deptCode=electrical&courseCode=1234", status().isNotFound(), "");
    }
    ...
    public void testInvalidCourseInstructor() throws Exception {
        performGetRequestTest("/findCourseInstructor","deptCode=electrical&courseCode=1234", status().isNotFound(), "Course Not Found");
    }
    ...
    public void testInvalidCourseTime() throws Exception {
        performGetRequestTest("/findCourseTime","deptCode=electrical&courseCode=1234", status().isNotFound(), "Course Not Found");
    }
    ...
    public void addStudentToDepartment() throws Exception {
        performPatchRequestTest("/addMajorToDept","deptCode=COMS", status().isOk(), "Attribute was updated successfully");
    }

    @Test
    public void addStudentToDepartment2() throws Exception {
        performPatchRequestTest("/addMajorToDept","deptCode=electrical", status().isNotFound(), "Department Not Found");
    }
    ...
    public void testRemoveStudentFromDepartment() throws Exception {
        performPatchRequestTest("/removeMajorFromDept","deptCode=COMS", status().isOk(), "Attribute was updated or is at minimum");
    }

    @Test
    public void testRemoveStudentFromDepartment2() throws Exception {
        performPatchRequestTest("/removeMajorFromDept","deptCode=electrical", status().isNotFound(), "Department Not Found");
    }
    ...
    public void testDropStudentFromCourse() throws Exception {
        performPatchRequestTest("/dropStudentFromCourse","deptCode=COMS&courseCode=3261", status().isOk(), "Student has been dropped");
    }
    ...
    public void testEnrollmentCount2() throws Exception {
        performPatchRequestTest("/setEnrollmentCount","deptCode=electrical&courseCode=1234&count=450", status().isNotFound(), "Course Not Found");
    }

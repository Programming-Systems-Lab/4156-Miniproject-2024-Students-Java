...
public class RouteControllerUnitTest {
  ...
  public void indexTest() throws Exception {
    ...
    public void retrieveCourseTest() throws Exception {
        String deptCode = "COMS";
        int courseCode = 4156;
        String expectedJson = "{\"instructorName\":\"Gail Kaiser\",\"courseLocation\":\"501 NWC\"}";

        // Case that the department code and course code are valid, we see if the instructor is Gail Kaiser and courseLocation is 501 NWC
    ...
    public void findCourseInstructorTest() throws Exception {
        ...
        // Case that the department code and course code are valid, we expect the instructor to be Gail Kaiser

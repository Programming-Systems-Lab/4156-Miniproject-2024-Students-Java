...
public class IndividualProjectApplication implements CommandLineRunner {
  ...
  public void resetDataFile() {
    ...
    Department econ = new Department("ECON", courses,
        "Michael Woodford", 2345);
    mapping.put("ECON", econ);

    //data for ieor dept
    Course ieor2500 = new Course("Uday Menon", "627 MUDD",
        times[0], 50);
    ieor2500.setEnrolledStudentCount(52);
    Course ieor3404 = new Course("Christopher J Dolan", "303 MUDD",
        times[2], 73);
    ieor3404.setEnrolledStudentCount(80);
    Course ieor3658 = new Course("Daniel Lacker", "310 FAY",
        times[2], 96);
    ieor3658.setEnrolledStudentCount(87);
    Course ieor4102 = new Course("Antonius B Dieker", "209 HAM",
        times[2], 110);
    ieor4102.setEnrolledStudentCount(92);
    Course ieor4106 = new Course("Kaizheng Wang", "501 NWC",
        times[2], 150);
    ieor4106.setEnrolledStudentCount(161);
    Course ieor4405 = new Course("Yuri Faenza", "517 HAV",
        times[0], 80);
    ieor4405.setEnrolledStudentCount(19);
    Course ieor4511 = new Course("Michael Robbins", "633 MUDD",
        "9:00-11:30", 150);
    ieor4511.setEnrolledStudentCount(50);
    Course ieor4540 = new Course("Krzysztof M Choromanski", "633 MUDD",
        "7:10-9:40", 60);

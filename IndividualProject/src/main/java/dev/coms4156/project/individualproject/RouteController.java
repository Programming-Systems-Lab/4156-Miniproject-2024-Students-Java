...
public class RouteController {
  ...
  /**
   * This method sets the enrollment count of a course to a new value.
   * 
   * 
   * <p>@param deptCode       A {@code String} representing the department
   * 
   * <p>@param courseCode     A {@code int} representing the course within the department
   * 
   * <p>@param count          A {@code int} representing the new enrollment count
   * 
   * <p>@return               A ResponseEntity with a success message if the operation is
  ...
  * <p>@param deptCode       A {@code String} representing the department.
  *
  * <p>@param courseCode     A {@code int} representing the course the user wishes to update.
  *
  * <p>@param location       A {@code String} representing the new location for the course.
  *
  * <p>@return               A ResponseEntity with a success message if the operation is
  *                       successful, or an error message if the course is not found
  */

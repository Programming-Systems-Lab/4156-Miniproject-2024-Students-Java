...
public class RouteController {
  ...
  /**
   * Updates the number of students enrolled in a specified course.
   *
   * @param deptCode the department code containing the course.
   * @param courseCode the course code within the department.
   * @param count the new number of students enrolled in the course.
   * @return an object containing a success message with HTTP 200 response if
   *     the update is successful, or an appropriate error message and HTTP status code
   ...
   * @return an object containing a success message with HTTP 200 response if
   *     the location is updated successfully, or an appropriate error message
   *     and HTTP status code if the course is not found.
   */

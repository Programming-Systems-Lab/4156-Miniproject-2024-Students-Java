...
public class RouteController {
  ...
  /**
   * Displays the number of people in a major in the specified department.
   *
   * @param deptCode     A {@code String} representing the department the user wishes
  ...
  /**
   * Attempts to set an enrollment count to a course.
   *
   * @param deptCode      A string representing the department.
   * @param courseCode    An int representing the course within the department.
   * @param count         An int representing the enrollment count of a course
   * @return              A ResponseEntity that sends success if operation was successful and
   *                      an error message if the course was not found
   */
   ...
   *
   * @param deptCode     A String representing the department code
   * @param courseCode   An int representing the course code
   * @param location     A String representing the location of the course
   * @return             Returns a ResponseEntity with a success message if operation is success

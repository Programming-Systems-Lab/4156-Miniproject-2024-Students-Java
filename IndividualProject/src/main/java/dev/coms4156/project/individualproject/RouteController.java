...
public class RouteController {
  ...
  /**
   * Sets the enrollment for a given course in a given department.
   *
   * @param deptCode       A {@code String} representing the department.
   *
   * @param courseCode     A {@code int} representing the course within the department.
   *
   * @param count          A {@code int} representing the enrollment count for given course.
   *
   * @return               A {@code ResponseEntity} If is successful, it will contain a sucess
   *                       message and HTTP 200. If course not found, it will contain an error
   *                       message or a response with an appropriate
   *                       message
   */
  ...
  /**
   * Endpoint for changing the location of a course in  a given department.
   ...
   *
   * @param deptCode                  A {@code String} the code of the department
   * @param courseCode                A {@code int} the code of the course in department
   * @param location                  A {@code String} the new location for the course
   *
   * @return                          a ResponseEntity with a success message and HTTP 200 if the
   *                                  operation is successful, or an error message if the course is
   *                                  not found
   */

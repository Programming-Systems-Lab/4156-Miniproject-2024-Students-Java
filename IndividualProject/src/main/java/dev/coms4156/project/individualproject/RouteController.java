 ...
 *
 * @param deptCode    the department code as a {@code String}.
 * 
 * @param courseCode  the course code within the department as an {@code int}.
 * 
 * @param count       the new enrollment count to be set as an {@code int}.
 * 
 * @return          A {@code ResponseEntity} object containing an HTTP 200
   *                       response with an appropriate message or the proper status
   *                       code in tune with what has happened.
 */
  ...
  /**
   * Changes the location of a specific course within a department.
   *

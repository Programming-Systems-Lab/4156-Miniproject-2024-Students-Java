...
public class RouteController {
  ...
  /**
   * Updates the enrollment count for a specific course in a department.
   *
   * @param deptCode   A {@code String} representing the department.
   * @param courseCode A {@code int} representing the course within the department.
   ...
   *
   * @param deptCode   A {@code String} representing the department code where the course is from.
   * @param courseCode A {@code int} representing the course within the department.
   * @param location   A {@code String} representing the new location of the course.
   * @return A {@code ResponseEntity} object containing a success message if the operation is
   *           successful or an error message if the course was not found.
   */

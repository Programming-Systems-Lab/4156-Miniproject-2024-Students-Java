...
public class RouteController {
  ...
  public ResponseEntity<?> retrieveDepartment(@RequestParam("deptCode") String deptCode) {
    try {
      ...
      String upperCaseDeptCode = deptCode.toUpperCase(Locale.ROOT);
      if (!departmentMapping.containsKey(upperCaseDeptCode)) {
        return new ResponseEntity<>("Department Not Found", HttpStatus.NOT_FOUND);
      } else {
        return new ResponseEntity<>(departmentMapping.get(upperCaseDeptCode).toString(),
            HttpStatus.OK);
      }

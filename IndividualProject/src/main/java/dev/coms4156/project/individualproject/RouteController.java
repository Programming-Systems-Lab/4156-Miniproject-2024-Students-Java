...
public class RouteController {
  ...
  public ResponseEntity<?> retrieveDepartment(@RequestParam(value = "deptCode") String deptCode) {
    try {
      ...
      departmentMapping = IndividualProjectApplication.systemDatabase.getDepartmentMapping();
  ...
  /**
   * Sets the enrollment count for a given course.
   *
   * @param deptCode    A {@code String} representing the department.
   * @param courseCode  A {@code int} representing the course within the department.
   ...
   *
   * @return            A {@code ResponseEntity} object containing an HTTP 200
   *                    response with a success message if the operation is successful,
   *                    or, an appropriate message indicating the proper response.
   */
  ...
  /**
   * Changes the location of a given course.
   *
   * @param deptCode    A {@code String} representing the department.
   * @param courseCode  A {@code int} representing the course within the department.

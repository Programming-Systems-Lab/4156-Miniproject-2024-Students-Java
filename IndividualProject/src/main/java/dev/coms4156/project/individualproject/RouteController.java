...
public class RouteController {
  ...
  public static final String ATTRIBUTE_SUCCESSFULLY_UPDATED = "Attribute was updated successfully.";
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam(value = DEPT_CODE_PARAM)
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        return new ResponseEntity<>(ATTRIBUTE_SUCCESSFULLY_UPDATED, HttpStatus.OK);
      } else {
        return new ResponseEntity<>(COURSE_NOT_FOUND, HttpStatus.NOT_FOUND);
      }
    } catch (Exception e) {

...
public class RouteController {
  ...
  /**
   * Sets the enrollment count for a specified course.
   *
   * @param deptCode   A {@code String} representing the department the course is in.
   * @param courseCode A {@code int} representing the course for which the count is set.
   * @param count      The new enrollment count for the course.
   * @return A {@code ResponseEntity} object containing an appropriate response message.
   */
   ...
   * @return a {@code ResponseEntity} object with a success message if the operation is
